...
class Search extends Component {
      ...
      updateSearch = search => {
        this.setState({ search }, () => { //Set State is Async, so need to do things in callback function
      ...
      renderSearchResults() {
        return (
          <View>
            <SearchResultProduct products = {this.state.searchResultProducts} client = {client} />
          </View>
        )
      };
        ...
        return (
          <View>
            <KeyboardAvoidingView>
             ...
             <View style = {{backgroundColor: 'white'}}>{this.renderResultsContainer()}</View>
             </View>
        );
      }
